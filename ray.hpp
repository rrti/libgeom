#ifndef LIBGEOM_RAY_HDR
#define LIBGEOM_RAY_HDR
...
namespace lib_math {
	...
	private:
		...
		// other possible representation would be
		//   m_point_type m_pos_a;
		//   m_point_type m_pos_b;
		// with an interpolation parameter t=[0,1]
		//
