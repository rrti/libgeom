...
namespace lib_math {
	static const t_vector4f      eps_vector_4f = t_vector4f(M_EPS_F, M_EPS_F, M_EPS_F,  0.0f);
	static const t_vector4f      inf_vector_4f = t_vector4f(M_INF_F, M_INF_F, M_INF_F,  0.0f);
